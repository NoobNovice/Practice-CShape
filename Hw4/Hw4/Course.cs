...
namespace Hw4
{
    public class Course
    {
        ...
        {
            if (no_students < max_students)
            {
                if (studentList.Found(s))
                {
                    Console.WriteLine("Error this Student already enrolled");
                    return false;
                }
                else
                {
                    ...
                    no_students++;
                    Console.WriteLine(s.Id + " has enrolled " + this.course_id + " successfully. ");
                    return true;
                }
        ...
        public bool RemoveStudent(Student s)
        {
            if (studentList.Found(s))
            {
                ...
                no_students--;
                Console.WriteLine(s.Id + " has been removed from " + course_id + " successfully.");
                return true;
            }
            else
            {
                Console.WriteLine(s.Id + " is NOT enrolled in " + course_id + ".");
                return false;
            }
        }
    }
